    ...
    <main className="flex-1 overflow-y-auto px-6 py-5 space-y-5 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-thumb]:bg-gray-200 [&::-webkit-scrollbar-thumb]:rounded">
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-3">
        <StatCard
          ...
          value="3"
          sub="Last session: 2 weeks ago"
          accent="bg-[#1a5c2a]"
        />
        <StatCard
          label="Assessments Taken"
          value="2"
          sub="PHQ-9 · GAD-7 completed"
          accent="bg-yellow-400"
        />
        <StatCard
          label="Upcoming Appointments"
          value="1"
          sub="Wednesday, 22 May 2026"
          accent="bg-blue-400"
        />
        <StatCard
          label="Messages"
          value="3"
          sub="2 unread from counsellor"
          accent="bg-red-400"
        />
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-50">
            <h2 className="text-[13px] font-semibold text-gray-900">Upcoming Appointment</h2>
            <Link href="/dashboard/student/book" className="text-[11.5px] text-[#1a5c2a] font-medium hover:underline">
              Book new →
            </Link>
          </div>
          <div className="px-5 py-4">
            <div className="flex items-start gap-4 p-4 bg-[#e8f5ec] border border-[#b6dfc0] rounded-xl">
              ...
              <div className="flex-1">
                <p className="text-[13px] font-semibold text-gray-900">Session with Mr. Alomaja</p>
                <p className="text-[11px] text-gray-500 mt-0.5">Wednesday, 22 May 2026 · 10:00 AM</p>
                <p className="text-[11px] text-gray-500">Physical · Student Affairs Building</p>
              </div>
            ...
            <p className="text-[11px] text-gray-400 mt-3 text-center">
              ...
              <Link href="/dashboard/student/book" className="text-[#1a5c2a] hover:underline">Book one</Link>
            </p>
          </div>
        </div>
